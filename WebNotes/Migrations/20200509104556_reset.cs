        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NoteContent = table.Column<string>(maxLength: 800, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    UserUniqueName = table.Column<string>(nullable: true),
                    TimeNoteSent = table.Column<DateTime>(nullable: false),
                    Title = table.Column<string>(nullable: true),
                    NoteContent = table.Column<string>(nullable: true),
                    SenderUserUniqueName = table.Column<string>(nullable: true),
                    UserName = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
